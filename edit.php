...
<div class="container">
   ...
   <div class="row justify-content-center">
      <h1 class="h2 bold-3 my-5 max-width-5x text-center">Update Data Hotel</h1>
   </div>
...
<div class="container">
   ...
   <a href="input.php" class="btn btn-primary pull-left mt-4"><span class="glyphicon glyphicon-step-backward"></span>Back</a>
   <br>
   <hr>
   <div class="card-body">
      ...
      <form class="card-body mb-4 mt-4" method="post">
         <div class="panel-body">
            ...
            <div class="form-group">
               <label class="control-label col-sm-2 mb-2">Nama Hotel:<span style='color:red'>*</span></label>
               <div class="col-sm-5 mb-2">
                  <input class="form-control" value="<?= $user->nama ?>" name="nama" required>
               </div>
            </div>
            <div class="form-group">
               <label class="control-label col-sm-2 mb-2">Jenis:<span style='color:red'>*</span></label>
               <div class="col-sm-5 mb-2">
                  <input class="form-control" value="<?= $user->jenis ?>" name="jenis" required>
               </div>
            </div>
            <div class="form-group">
               <label class="control-label col-sm-2">Alamat Hotel:<span style='color:red'>*</span></label>
